class Translation(object):
    START_TEXT = """Hi I'm Url Uploader Bot 🙃 {} ,
...
URL | filename | username | password"""
    DOWNLOAD_START = "Download started in **Beast 💥 mode...**"
    UPLOAD_START = "Processing upload..."
    RCHD_TG_API_LIMIT = "Downloaded in {} seconds.\nDetected File Size: {}\nSorry. But, I cannot upload files greater than 2GB due to Telegram API limitations."
    AFTER_SUCCESSFUL_UPLOAD_MSG = "Thank you <a href='https://t.me/starkownerbot'>**Stark Owner Bot**</a> for helping us in this journey ❤️"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Downloaded in {} seconds.\nUploaded in {} seconds.\n\n@starkownerbot"
    SAVED_CUSTOM_THUMB_NAIL = "Custom video / file thumbnail saved. This image will be used in the video / file."
    DEL_ETED_CUSTOM_THUMB_NAIL = "✅ Custom thumbnail cleared succesfully."
    CUSTOM_CAPTION_UL_FILE = "{}"
    NO_VOID_FORMAT_FOUND = "ERROR...\n<b>starkownerbot</b> said: {}"
...
Contact ADMIN if any error occurs @starkownerbot"""
...
The starkownerbot has not allowed me to upload files from the urls which is send by an unAuthorised member.
